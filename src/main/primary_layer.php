    ...
    <section class="about section">
        <div class="section-inner">
            ...
            <div class="content">
                ...
                <p>My research interest is the design of distributed
                    and operating systems, principally in consistency of
                    partially-replicated distributed data stores.
                </p>
            </div><!--//content-->
        </div><!--//section-inner-->
    </section><!--//section-->
    ...
    <div class="section-inner">
        ...
        <div class="content">
            <div class="item">
                ...
                <p>Design of distributed and operating systems, principally in consistency of partially-replicated distributed data stores.</p>
            </div><!--//item-->
            <div class="item">
                ...
                <p>Provide mechanisms, within the Linux kernel, to properly and efficiently size the cache that a container has, by proposing different heuristics whose purpose is to improve the approximation of the age of the pages, at acceptable cost.</p>
            </div><!--//item-->
            ...
            <div class="item">
                ...
                <p>Optimizing the distribution of the software computation costs and applying real-time Linux patches on an embedded ship for the automobile.</p>
            </div><!--//item-->
